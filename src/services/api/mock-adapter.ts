...
const routes: RouteHandler[] = [
  ...
  },
  {
    ...
    handler: (config) => {
      const body = JSON.parse(config.data || '{}') as CreateReporteRequest;
      const newReporte: Reporte = {
        _id: generateMockId(),
        nombre_objeto: body.nombre_objeto,
  ...
  },
  {
    ...
    handler: (config) => {
      ...
      const body = JSON.parse(config.data || '{}') as DevolverReporteRequest;
      ...
      reportesMock[idx] = {
        ...reportesMock[idx],
        estado: 'devuelto',
        devuelto_a_nombre: body.devuelto_a_nombre,
        devuelto_a_cedula: body.devuelto_a_cedula,
        devuelto_a_telefono: body.devuelto_a_telefono,
